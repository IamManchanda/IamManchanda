...
I am a **Full Stack Java, Javascript, and TypeScript Developer**, and my current Full Stack for building Web Apps, Mobile Apps & API's revolves around that. I hold a **Master's Degree in _Computer Applications_**, and is an **Amazon Web Services (AWS) Certified Developer Associate**.
